...
;(allocator-setup "../good-collectors/mark_and_sweep_collector.rkt" 90)
;(allocator-setup "../good-collectors/stop_and_copy_collector.rkt" 140)
(allocator-setup "../good-collectors/mark_and_compact_collector.rkt" 95)
